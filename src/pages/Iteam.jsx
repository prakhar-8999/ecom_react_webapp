                ...
                <section class="text-gray-600 body-font overflow-hidden">
                    <div class="container px-5 py-24 mx-auto">
                        <div class="lg:w-4/5 mx-auto flex flex-wrap">
                            <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto object-cover object-center rounded" src={staticdata.baseurl + 'media/' + pdata.product_image} />
                            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                                <h2 class="text-sm title-font text-gray-500 tracking-widest">{pdata.product_id}</h2>
                                <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">{pdata.product_name}</h1>
                                <div class="flex mb-4">
                                ...
                                <p class="leading-relaxed">{pdata.product_description}</p>
                                ...
                                <div class="flex">
                                    <span class="title-font font-medium text-2xl text-gray-900"><i class="fa-sharp fa-solid fa-indian-rupee-sign"></i> &nbsp;{pdata.product_price}</span>
                                    <button onClick={placeOrder} class="flex ml-auto text-white bg-orange-500 border-0 py-2 px-6 focus:outline-none hover:bg-orange-600 rounded">Place Order{btnloader ? <i className="fas fa-circle-notch fa-spin" style={{ marginLeft: "20px" }} /> : null}</button>
                                    <button class="hidden md:block rounded-full w-10 h-10 bg-gray-200 p-0 border-0 inline-flex items-center justify-center text-gray-500 ml-4">
                                        <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
