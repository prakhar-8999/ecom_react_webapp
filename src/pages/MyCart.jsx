            ...
            <>
                            ...
                            <div class="w-full bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700" key={c.product_id}>
                                ...
                                <div class="px-5 pb-5">
                                    ...
                                    <div class="flex justify-between items-center">
                                        ...
                                        <div class="w-[10rem] mt-6 relative mb-6">
                                            <select onChange={(e) => setquantity(e.target.value, c.userid, c.product_id)} id="countries" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <center>
                    <div style={{ width: '100%', display: cart.length === 0 ? 'none' : 'block' }}>
                        <button onClick={orderAll} type="button" class="w-full focus:outline-none text-white bg-orange-700 hover:bg-orange-800 focus:ring-4 focus:ring-orange-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-orange-700 dark:focus:ring-orange-900">Place Order{btnloader ? <i className="fas fa-circle-notch fa-spin" style={{ marginLeft: "20px" }} /> : null}</button>
                    </div>
                </center>
