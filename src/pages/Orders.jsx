                                ...
                                <div className="p-4 w-full bg-white rounded-lg border shadow-md sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                                    <div className="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                                        <div className="grid grid-cols-1 md:grid-cols-3">
                                            ...
                                            <div>
                                                <p className='opacity-60 text-sm' style={{ float: 'left' }}>{o.product_id}</p><br />
                                                <p className='text-xl' style={{ float: 'left' }}><b>{o.product_name.toLowerCase()}</b></p><br /><br />
                                            ...
                                            <div className='justify-end items-end'>
                                                <p className='mt-3 sm:mt-6 sm:ml-12' style={{ float: 'left' }}>Quantity : <span style={{ color: 'darkcyan' }}>{o.product_quantity}</span></p><br /><br />
                                                <p className='mt-3 sm:mt-16 sm:ml-12' style={{ float: 'left' }}>Price : <span>{o.product_price}</span></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
